...
get the app created:
    ...
    $ heroku apps:create clj_drain
    Creating clj_drain... done, stack is cedar
    http://clj_drain.herokuapp.com/ | git@heroku.com:clj_drain.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://clj_drain.herokuapp.com deployed to Heroku

    To git@heroku.com:clj_drain.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://clj_drain.herokuap.com
    ["Hello" :from Heroku]
